    ...
    icon: (
      ...
      >
        <path
          ...
          strokeLinejoin="round"
          strokeWidth={2}
          d="M9 20l-5.447-2.724A2 2 0 013 15.382V5.618a2 2 0 011.553-1.894L9 1m0 0l6 2.618M9 1v19m6-16.382l5.447-2.724A2 2 0 0121 5.618v9.764a2 2 0 01-1.553 1.894L15 20m0 0V1m0 19l-6-2.618"
        />
      </svg>
    ),
  },
